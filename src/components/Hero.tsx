          ...
          <div className="space-y-8">
            ...
            >
              <button
                ...
                className="group relative px-8 py-4 bg-accent hover:bg-accent/80 rounded-full font-semibold transition-all duration-300 transform hover:scale-105"
              >
              ...
              <div className="flex space-x-4">
                <a
                  href="https://github.com/dorijantomic"
                ...
                <a
                  href="https://www.linkedin.com/in/dorijan/"
                  className="w-12 h-12 glass rounded-full flex items-center justify-center hover:bg-white/10 transition-all duration-300 transform hover:scale-110"
                >
                  <svg
                    className="w-5 h-5"
